...
namespace HappyHarvest
{
    ...
    {
        public static void ShowAutonomousControls()
        {
            var inventory = s_Instance?.m_Document.rootVisualElement.Q("Inventory");
            if (inventory != null) inventory.style.display = DisplayStyle.None;
        }
